...
const awsrequestsigner_1 = require("../src/auth/awsrequestsigner");
mocha_1.describe('AwsRequestSigner', () => {
    let clock;
    ...
    mocha_1.describe('getRequestOptions()', () => {
        ...
        const getRequestOptionsTests = [
            {
                ...
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                ...
                getSignedRequest: () => {
                    const signature = 'b27ccfbfa7df52a200ff74193ca6e32d4b48b8856fab7ebf1c595d0670a7e470';
                    return {
                        url: 'https://host.foo.com',
                        method: 'GET',
                        headers: {
                            Authorization: 'AWS4-HMAC-SHA256 Credential=AKIDEXAMPLE/20110909/us-east-1/host/' +
            ...
            },
            {
                ...
                description: 'signed GET request with relative path (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
            ...
            },
            {
                ...
                description: 'signed GET request with pointless dot path (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
                ...
                getSignedRequest: () => {
                    const signature = '910e4d6c9abafaf87898e1eb4c929135782ea25bb0279703146455745391e63a';
                    return {
                        url: 'https://host.foo.com/./foo',
                        method: 'GET',
                        headers: {
            ...
            },
            {
                ...
                getSignedRequest: () => {
                    const signature = '8d6634c189aa8c75c2e51e106b6b5121bed103fdb351f7d7d4381c738823af74';
                    return {
                        url: 'https://host.foo.com/%E1%88%B4',
                        method: 'GET',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed GET request with uplicate query key (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
                ...
                getSignedRequest: () => {
                    const signature = 'be7148d34ebccdc6423b19085378aa0bee970bdc61d144bd1a8c48c33079ab09';
                    return {
                        url: 'https://host.foo.com/?foo=Zoo&foo=aha',
                        method: 'GET',
                        headers: {
            ...
            },
            {
                ...
                getSignedRequest: () => {
                    const signature = '6fb359e9a05394cc7074e0feb42573a2601abc0c869a953e8c5c12e4e01f1a8c';
                    return {
                        url: 'https://host.foo.com/?ሴ=bar',
                        method: 'GET',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed POST request with sorted headers (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
                ...
                getSignedRequest: () => {
                    const signature = 'b7a95a52518abbca0964a999a880429ab734f35ebbf1235bd79a5de87756dc4a';
                    return {
                        url: 'https://host.foo.com/',
                        method: 'POST',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed POST request with upper case header value from ' +
                ...
                getSignedRequest: () => {
                    const signature = '273313af9d0c265c531e11db70bbd653f3ba074c1009239e8559d3987039cad7';
                    return {
                        url: 'https://host.foo.com/',
                        method: 'POST',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed POST request with header and no body (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
                ...
                getSignedRequest: () => {
                    const signature = 'debf546796015d6f6ded8626f5ce98597c33b47b9164cf6b17b4642036fcb592';
                    return {
                        url: 'https://host.foo.com',
                        method: 'POST',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed POST request with body and no header (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
                ...
                getSignedRequest: () => {
                    const signature = '5a15b22cf462f047318703b92e6f4f38884e4a7ab7b1d6426ca46a8bd1c26cbc';
                    return {
                        url: 'https://host.foo.com',
                        method: 'POST',
                        headers: {
            ...
            },
            {
                ...
                description: 'signed POST request with querystring (AWS botocore tests)',
                referenceDate: new Date('2011-09-09T23:36:00.000Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(async () => {
                    return {
                        accessKeyId: 'AKIDEXAMPLE',
            ...
            },
            {
                ...
                instance: new awsrequestsigner_1.AwsRequestSigner(getCredentials, 'us-east-2'),
                originalRequest: {
                ...
                getSignedRequest: () => {
                    ...
                    const signature = '631ea80cddfaa545fdadb120dc92c9f18166e38a5c47b50fab9fce476e022855';
                    return {
                        url: 'https://ec2.us-east-2.amazonaws.com?' +
                            'Action=DescribeRegions&Version=2013-10-15',
                        method: 'GET',
            ...
            },
            {
                ...
                getSignedRequest: () => {
                    const amzDate = '20200811T065522Z';
                    const dateStamp = '20200811';
                    const signature = '73452984e4a880ffdc5c392355733ec3f5ba310d5e0609a89244440cadfe7a7a';
                    return {
                        url: 'https://sts.us-east-2.amazonaws.com' +
                            '?Action=GetCallerIdentity&Version=2011-06-15',
                        method: 'POST',
            ...
            },
            {
                ...
                referenceDate: new Date('2020-08-11T06:55:22.345Z'),
                instance: new awsrequestsigner_1.AwsRequestSigner(getCredentialsWithoutToken, 'us-east-2'),
                originalRequest: {
                    url: 'https://sts.us-east-2.amazonaws.com' +
                        '?Action=GetCallerIdentity&Version=2011-06-15',
                    method: 'POST',
                ...
                getSignedRequest: () => {
                    const amzDate = '20200811T065522Z';
                    const dateStamp = '20200811';
                    const signature = 'd095ba304919cd0d5570ba8a3787884ee78b860f268ed040ba23831d55536d56';
                    return {
                        url: 'https://sts.us-east-2.amazonaws.com' +
                            '?Action=GetCallerIdentity&Version=2011-06-15',
                        method: 'POST',
            ...
            },
            {
                ...
                getSignedRequest: () => {
                    const amzDate = '20200811T065522Z';
                    const dateStamp = '20200811';
                    const signature = 'fdaa5b9cc9c86b80fe61eaf504141c0b3523780349120f2bd8145448456e0385';
                    return {
                        url: 'https://dynamodb.us-east-2.amazonaws.com/',
                        method: 'POST',
                        headers: {
        ...
        getRequestOptionsTests.forEach(test => {
            mocha_1.it(`should resolve with the expected ${test.description}`, async () => {
                clock.tick(test.referenceDate.getTime());
                const actualSignedRequest = await test.instance.getRequestOptions(test.originalRequest);
                assert.deepStrictEqual(actualSignedRequest, test.getSignedRequest());
            });
        });
        mocha_1.it('should reject with underlying getCredentials error', async () => {
            const awsRequestSigner = new awsrequestsigner_1.AwsRequestSigner(getCredentialsUnsuccessful, 'us-east-2');
            const options = {
                url: 'https://sts.us-east-2.amazonaws.com' +
                    '?Action=GetCallerIdentity&Version=2011-06-15',
                method: 'POST',
            };
            await assert.rejects(awsRequestSigner.getRequestOptions(options), awsError);
        });
        mocha_1.it('should reject when no URL is available', async () => {
            const invalidOptionsError = new Error('"url" is required in "amzOptions"');
            const awsRequestSigner = new awsrequestsigner_1.AwsRequestSigner(getCredentials, 'us-east-2');
            await assert.rejects(awsRequestSigner.getRequestOptions({}), invalidOptionsError);
        });
    });
});
//# sourceMappingURL=test.awsrequestsigner.js.map